...
import com.shantoo.develop.library.ui.widget.banner.listener.OnBannerClickListener;
import com.shantoo.develop.library.ui.widget.banner.listener.OnBannerListener;
import com.shantoo.develop.library.ui.widget.banner.loader.ImageLoaderInterface;
import com.shantoo.develop.library.ui.widget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
     ...
     * current page in the com.ldwl.qlddsc.view hierarchy in an idle state. Pages beyond this
