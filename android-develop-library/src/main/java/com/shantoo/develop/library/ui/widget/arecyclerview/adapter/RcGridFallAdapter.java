 ...
 */
public class RcGridFallAdapter extends ARecyclerBaseAdapter<RcGridFallAdapter.MyViewHolder, String> {

    public RcGridFallAdapter(Context mContext, List<String> mList) {
